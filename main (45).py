...
section[data-testid="stSidebar"] .stRadio [aria-checked="true"] label span { color: #7db8f7 !important; }
...
.stSelectbox [data-baseweb="select"] div { color: #0f1117 !important; }
...
[data-testid="stFileUploaderDropzoneInstructions"] span { color: #1e40af !important; }
...
[data-testid="stMetricDelta"] { color: #6b7280 !important; font-size: 11px !important; }
...
/* ═══════════════════════════════════════════════
   DATAFRAME
═══════════════════════════════════════════════ */
.stDataFrame, .stDataFrame * { color: #0f1117 !important; background-color: #ffffff !important; }
...
.gc-card, .gc-card * { color: #0f1117 !important; }
.gc-card-header {
  font-size: 10px !important;
  font-weight: 700 !important;
...
.badge-closed  { background:#dcfce7; color:#15803d !important; }
...
.badge-draft   { background:#f3f4f6; color:#4b5563 !important; }
...
.gc-tl, .gc-tl * { color: #4b5563 !important; }
.gc-tl::before {
  content: '';
  position: absolute;
...
.cl-owner-card, .cl-owner-card * { color: #0f1117 !important; }
.cl-task-row {
...
.cl-task-row, .cl-task-row * { color: #0f1117 !important; }
...
.stSelectbox svg, .stMultiSelect svg { fill: #6b7280 !important; }

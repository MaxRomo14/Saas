...
.stDataFrame tbody td { color: #111827 !important; font-size: 13px !important; }
.gc-card {
...
.gc-header p { font-size: 13px; color: #6b7280; margin: 0; }
.gc-alert { border-radius: 6px; padding: 0.7rem 1rem; margin: 0.5rem 0; font-size: 13px; line-height: 1.5; }
.gc-alert-warn   { background: #fffbeb; border-left: 3px solid var(--warn);    color: #92400e; }
.gc-alert-danger { background: #fef2f2; border-left: 3px solid var(--danger);  color: #991b1b; }
.gc-alert-ok     { background: #f0fdf4; border-left: 3px solid var(--success); color: #166534; }
...
.login-logo { font-size: 1.8rem; font-weight: 700; color: var(--navy); letter-spacing: -0.02em; text-align: center; margin-bottom: 0.2rem; }
.login-sub { text-align: center; color: #6b7280; font-size: 12px; margin-bottom: 2rem; text-transform: uppercase; letter-spacing: 0.1em; font-weight: 500; }
</style>

...
def page_evidence():
    ...
    <div style='background:#1e293b;border-radius:8px;padding:.7rem 1.1rem;margin-bottom:.8rem;
      ...
      <div>
        <div style='font-size:9px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:.08em'>Total Files</div>
        <div style='font-size:22px;font-weight:800;color:#f8fafc;line-height:1.2'>{total:,}</div>
      </div>
      <div>
        <div style='font-size:9px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:.08em'>Est. Size</div>
        <div style='font-size:22px;font-weight:800;color:#60a5fa;line-height:1.2'>{total_size_gb:.1f} GB</div>
      </div>
      <div>
        <div style='font-size:9px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:.08em'>Departments</div>
        <div style='font-size:22px;font-weight:800;color:#34d399;line-height:1.2'>{len(all_depts)}</div>
      </div>
      <div>
        <div style='font-size:9px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:.08em'>Document Types</div>
        <div style='font-size:22px;font-weight:800;color:#a78bfa;line-height:1.2'>{len(all_types)}</div>
      </div>
      <div style='flex:1;min-width:200px'>
        <div style='font-size:9px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:.08em;margin-bottom:.2rem'>Top Document Types</div>
        <div style='font-size:11px;color:#cbd5e1'>{top_str}</div>
      </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with res_col:
        ...
        if not results:
            ...
            # ── Table header ──────────────────────────────────────────────────
            st.markdown("""
            <div style='display:grid;grid-template-columns:70px 2.2fr 100px 110px 130px 80px 70px 60px 80px;
            ...
            for i, ev in enumerate(page_results):
                ...
                row_html = (
                    f"<div style='display:grid;grid-template-columns:70px 2.2fr 100px 110px 130px 80px 70px 60px 80px;"

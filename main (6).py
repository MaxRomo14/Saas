...
.gc-header p { font-size: 13px; color: var(--text2); margin: 0; }

/* Alerts */
.gc-alert { border-radius: 6px; padding: 0.7rem 1rem; margin: 0.5rem 0; font-size: 13px; line-height: 1.5; }
.gc-alert-warn   { background: rgba(245,158,11,0.15);  border-left: 3px solid var(--warn);    color: #fcd34d; }
.gc-alert-danger { background: rgba(239,68,68,0.15);   border-left: 3px solid var(--danger);  color: #fca5a5; }
.gc-alert-ok     { background: rgba(34,197,94,0.15);   border-left: 3px solid var(--success); color: #86efac; }

hr { border: none; border-top: 1px solid var(--border) !important; margin: 1.2rem 0 !important; }
::-webkit-scrollbar { width: 6px; height: 6px; }
::-webkit-scrollbar-track { background: var(--navy); }
::-webkit-scrollbar-thumb { background: var(--border2); border-radius: 3px; }
p, li { line-height: 1.6 !important; color: var(--text) !important; }
...
.login-logo { font-size: 1.8rem; font-weight: 700; color: var(--text); letter-spacing: -0.02em; text-align: center; margin-bottom: 0.2rem; }
.login-sub { text-align: center; color: var(--text2); font-size: 12px; margin-bottom: 2rem; text-transform: uppercase; letter-spacing: 0.1em; font-weight: 500; }
</style>
